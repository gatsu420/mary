...
func (_m *MockUsecase) GetFood(ctx context.Context, id int32) (repository.GetFoodRow, error) {
	ret := _m.Called(ctx, id)
...
func (_c *MockUsecase_GetFood_Call) Return(_a0 repository.GetFoodRow, _a1 error) *MockUsecase_GetFood_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockUsecase_GetFood_Call) RunAndReturn(run func(context.Context, int32) (repository.GetFoodRow, error)) *MockUsecase_GetFood_Call {
	_c.Call.Return(run)
	return _c
}

// ListFood provides a mock function with given fields: ctx, arg
func (_m *MockUsecase) ListFood(ctx context.Context, arg *food.ListFoodParams) ([]repository.ListFoodRow, error) {
	ret := _m.Called(ctx, arg)
...
func (_c *MockUsecase_ListFood_Call) Return(_a0 []repository.ListFoodRow, _a1 error) *MockUsecase_ListFood_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockUsecase_ListFood_Call) RunAndReturn(run func(context.Context, *food.ListFoodParams) ([]repository.ListFoodRow, error)) *MockUsecase_ListFood_Call {
	_c.Call.Return(run)
	return _c
}
