...
func (_m *MockUsecase) GetMembershipRegistry(ctx context.Context) ([]string, error) {
	ret := _m.Called(ctx)
...
// MockUsecase_GetMembershipRegistry_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetMembershipRegistry'
type MockUsecase_GetMembershipRegistry_Call struct {
	*mock.Call
}

// GetMembershipRegistry is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockUsecase_Expecter) GetMembershipRegistry(ctx interface{}) *MockUsecase_GetMembershipRegistry_Call {
	return &MockUsecase_GetMembershipRegistry_Call{Call: _e.mock.On("GetMembershipRegistry", ctx)}
}

func (_c *MockUsecase_GetMembershipRegistry_Call) Run(run func(ctx context.Context)) *MockUsecase_GetMembershipRegistry_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockUsecase_GetMembershipRegistry_Call) Return(_a0 []string, _a1 error) *MockUsecase_GetMembershipRegistry_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockUsecase_GetMembershipRegistry_Call) RunAndReturn(run func(context.Context) ([]string, error)) *MockUsecase_GetMembershipRegistry_Call {
	_c.Call.Return(run)
	return _c
}
