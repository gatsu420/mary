...
func (_m *MockQuerier) DeleteFood(ctx context.Context, id int32) error {
	ret := _m.Called(ctx, id)
...
func (_c *MockQuerier_DeleteFood_Call) Return(_a0 error) *MockQuerier_DeleteFood_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockQuerier_DeleteFood_Call) RunAndReturn(run func(context.Context, int32) error) *MockQuerier_DeleteFood_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockQuerier) UpdateFood(ctx context.Context, arg *repository.UpdateFoodParams) error {
	ret := _m.Called(ctx, arg)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *repository.UpdateFoodParams) error); ok {
		r0 = rf(ctx, arg)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockQuerier_UpdateFood_Call) Return(_a0 error) *MockQuerier_UpdateFood_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockQuerier_UpdateFood_Call) RunAndReturn(run func(context.Context, *repository.UpdateFoodParams) error) *MockQuerier_UpdateFood_Call {
	_c.Call.Return(run)
	return _c
}
