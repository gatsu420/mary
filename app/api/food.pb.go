...
var file_food_proto_rawDesc = string([]byte{
	...
	0x74, 0x65, 0x64, 0x41, 0x74, 0x32, 0x71, 0x0a, 0x0b, 0x46, 0x6f, 0x6f, 0x64, 0x53, 0x65, 0x72,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2f, 0x61, 0x70,
...
var file_food_proto_depIdxs = []int32{
	...
	6,  // 3: api.ListRequest.intake_status:type_name -> google.protobuf.StringValue
	6,  // 4: api.ListRequest.feeder:type_name -> google.protobuf.StringValue
	6,  // 5: api.ListRequest.location:type_name -> google.protobuf.StringValue
	4,  // 6: api.ListResponse.food:type_name -> api.ListResponse.Row
	5,  // 7: api.ListResponse.Row.created_at:type_name -> google.protobuf.Timestamp
	5,  // 8: api.ListResponse.Row.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 9: api.FoodService.Create:input_type -> api.CreateRequest
	2,  // 10: api.FoodService.List:input_type -> api.ListRequest
	1,  // 11: api.FoodService.Create:output_type -> api.CreateResponse
	3,  // 12: api.FoodService.List:output_type -> api.ListResponse
